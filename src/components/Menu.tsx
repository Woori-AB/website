      ...
      <MenuSheet>
        ...
        <MenuRow cols={2}>
          ...
          <MenuColumn>
            ...
            <MenuItem>
              <MenuItemName i18n="menu.desserts.dessert-5.name" />
              <MenuItemPrice i18n="menu.desserts.dessert-5.price" />
              <MenuItemAllergens i18n="menu.desserts.dessert-5.allergens" />
            </MenuItem>
          </MenuColumn>
        </MenuRow>
      </MenuSheet>
